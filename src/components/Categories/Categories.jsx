...
const Categories = () => {
  return (
    <div className="categories" style={{ overflowX: 'hidden' }}>
      <div className="col">
        <div className="row">
